...
class __TwigTemplate_52d193eedb32670108da1c4a03c17215c3fba05a26687d35673940cbbc7dbaf0 extends \Twig\Template
{
    ...
    {
        // line 1
        echo "<h1>Say Hello to Grav!&nbsp;<a href='/admin/powertools/edit-section/?section=%23+Say+Hello+to+Grav%21'><i class='fa fa-edit' style='font-size:initial' title='Edit Section'></i></a></h1>
<h2>installation successful...&nbsp;<a href='/admin/powertools/edit-section/?section=%23%23+installation+successful...'><i class='fa fa-edit' style='font-size:initial' title='Edit Section'></i></a></h2>
...
<h3>Find out all about Grav&nbsp;<a href='/admin/powertools/edit-section/?section=%23%23%23+Find+out+all+about+Grav'><i class='fa fa-edit' style='font-size:initial' title='Edit Section'></i></a></h3>
<ul>
...
<h3>Edit this Page&nbsp;<a href='/admin/powertools/edit-section/?section=%23%23%23+Edit+this+Page'><i class='fa fa-edit' style='font-size:initial' title='Edit Section'></i></a></h3>
...
<h3>Create a New Page&nbsp;<a href='/admin/powertools/edit-section/?section=%23%23%23+Create+a+New+Page'><i class='fa fa-edit' style='font-size:initial' title='Edit Section'></i></a></h3>
<p>Creating a new page is a simple affair in <strong>Grav</strong>.  Simply follow these simple steps:</p>
<ol>
<li>Navigate to your pages folder: <code>user/pages/</code> and create a new folder.  In this example, we will use <a href=\"http://learn.getgrav.org/content/content-pages\">explicit default ordering</a> and call the folder <code>03.mypage</code>.</li>
<li>
...
<li>Save this file in the <code>user/pages/03.mypage/</code> folder as <code>default.md</code>. This will tell <strong>Grav</strong> to render the page using the <strong>default</strong> template.</li>
...
<p><a href=\"/admin/pages//\" target=\"_blank\">Edit Page On Grav</a></p>";
    ...
    {
        return new Source("<h1>Say Hello to Grav!&nbsp;<a href='/admin/powertools/edit-section/?section=%23+Say+Hello+to+Grav%21'><i class='fa fa-edit' style='font-size:initial' title='Edit Section'></i></a></h1>
<h2>installation successful...&nbsp;<a href='/admin/powertools/edit-section/?section=%23%23+installation+successful...'><i class='fa fa-edit' style='font-size:initial' title='Edit Section'></i></a></h2>
<p>Congratulations! You have installed the <strong>Base Grav Package</strong> that provides a <strong>simple page</strong> and the default <strong>Quark</strong> theme to get you started.</p>
<div class=\"notices red\">
<p>If you see a <strong>404 Error</strong> when you click <code>Typography</code> in the menu, please refer to the <a href=\"http://learn.getgrav.org/troubleshooting/page-not-found\">troubleshooting guide</a>.</p>
