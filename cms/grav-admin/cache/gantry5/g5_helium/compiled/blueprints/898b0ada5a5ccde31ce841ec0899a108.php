...
return [
    ...
    'timestamp' => 1569418059,
    'checksum' => '51aa4edae72ff165ec6a967cd57b6651',
    'files' => [
        'user/data/gantry5/themes/g5_helium/particles' => [
            ...
            'particles/logo-image-hover' => [
                'file' => 'user/data/gantry5/themes/g5_helium/particles/logo-image-hover.yaml',
                'modified' => 1567675866
            ],
    ...
    'data' => [
        'items' => [
            ...
            'particles.logo-image-hover.enabled' => [
                'type' => 'input.checkbox',
                'label' => 'Enabled',
                'description' => 'Globally enable the Logo | Image Hover Particle.',
                'default' => true,
                'name' => 'particles.logo-image-hover.enabled'
            ],
            'particles.logo-image-hover.tag' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.tag',
                'form_field' => false
            ],
            'particles.logo-image-hover.tag.attributes' => [
                ...
                'name' => 'particles.logo-image-hover.tag.attributes'
            ],
            'particles.logo-image-hover.css' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.css',
                'form_field' => false
            ],
            'particles.logo-image-hover.css.class' => [
                'type' => 'input.selectize',
                'label' => 'CSS Classes',
                'description' => 'Set a specific CSS class on the HTML container for custom styling.',
                'default' => 'g-logo',
                'name' => 'particles.logo-image-hover.css.class'
            ],
            'particles.logo-image-hover.render' => [
                'type' => 'select.select',
                'label' => 'Rendering',
                ...
                'name' => 'particles.logo-image-hover.render'
            ],
            'particles.logo-image-hover.link' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.link',
                'form_field' => false
            ],
            'particles.logo-image-hover.link.enabled' => [
                'type' => 'input.checkbox',
                'label' => 'URL enabled',
                'description' => 'Enable or disable the image link.',
                'default' => 1,
                'name' => 'particles.logo-image-hover.link.enabled'
            ],
            'particles.logo-image-hover.link.url' => [
                'type' => 'input.text',
                'label' => 'URL',
                'description' => 'URL assigned to the image. Leave this field empty to use home link.',
                'name' => 'particles.logo-image-hover.link.url'
            ],
            'particles.logo-image-hover.link.target' => [
                'type' => 'select.select',
                'label' => 'URL Target',
                ...
                'name' => 'particles.logo-image-hover.link.target'
            ],
            'particles.logo-image-hover.link.title' => [
                'type' => 'input.text',
                'label' => 'URL Title',
                'description' => 'The \'title\' attribute assigned to the link tag.',
                'name' => 'particles.logo-image-hover.link.title'
            ],
            'particles.logo-image-hover.text' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.text',
                'form_field' => false
            ],
            'particles.logo-image-hover.text.css' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.text.css',
                'form_field' => false
            ],
            'particles.logo-image-hover.text.css.class' => [
                'type' => 'input.selectize',
                'label' => 'CSS Classes',
                'description' => 'Set a specific CSS class on the text container for custom styling.',
                'name' => 'particles.logo-image-hover.text.css.class'
            ],
            'particles.logo-image-hover.text.text' => [
                'type' => 'input.text',
                'label' => 'Text',
                'description' => 'Additional or alternative text for image / logo.',
                'name' => 'particles.logo-image-hover.text.text'
            ],
            'particles.logo-image-hover.text.position' => [
                'type' => 'select.select',
                'label' => 'Text Position',
                ...
                'name' => 'particles.logo-image-hover.text.position'
            ],
            'particles.logo-image-hover.text.style' => [
                'type' => 'select.select',
                'label' => 'Text Style',
                ...
                'name' => 'particles.logo-image-hover.text.style'
            ],
            'particles.logo-image-hover.image' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.image',
                'form_field' => false
            ],
            'particles.logo-image-hover.image.default' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.image.default',
                'form_field' => false
            ],
            'particles.logo-image-hover.image.default.url' => [
                'type' => 'input.imagepicker',
                'label' => 'Image',
                'description' => 'Select the default logo or image.',
                'name' => 'particles.logo-image-hover.image.default.url'
            ],
            'particles.logo-image-hover.image.default.title' => [
                'type' => 'input.text',
                'label' => 'Title Text',
                'description' => 'The \'title\' attribute text for the default image.',
                'name' => 'particles.logo-image-hover.image.default.title'
            ],
            'particles.logo-image-hover.image.default.alt' => [
                'type' => 'input.text',
                'label' => 'Alt Text',
                'description' => 'The \'alt\' attribute text for the default image.',
                'name' => 'particles.logo-image-hover.image.default.alt'
            ],
            'particles.logo-image-hover.image.default.lazy_load' => [
                'type' => 'input.checkbox',
                'label' => 'Lazy Load',
                'description' => 'Enable or disable to manually force lazy loading attributes (requires library).',
                'default' => 0,
                'name' => 'particles.logo-image-hover.image.default.lazy_load'
            ],
            'particles.logo-image-hover.image.hover' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.image.hover',
                'form_field' => false
            ],
            'particles.logo-image-hover.image.hover.url' => [
                'type' => 'input.imagepicker',
                'label' => 'Image',
                'description' => 'Select the second logo or image for hover and timer effects.',
                'name' => 'particles.logo-image-hover.image.hover.url'
            ],
            'particles.logo-image-hover.image.hover.title' => [
                'type' => 'input.text',
                'label' => 'Title Text',
                'description' => 'The \'title\' attribute text for the second image.',
                'name' => 'particles.logo-image-hover.image.hover.title'
            ],
            'particles.logo-image-hover.image.hover.alt' => [
                'type' => 'input.text',
                'label' => 'Alt Text',
                'description' => 'The \'alt\' attribute text for the second image.',
                'name' => 'particles.logo-image-hover.image.hover.alt'
            ],
            'particles.logo-image-hover.image.hover.lazy_load' => [
                'type' => 'input.checkbox',
                'label' => 'Lazy Load',
                'description' => 'Enable or disable to manually force lazy loading attributes (requires library).',
                'default' => 0,
                'name' => 'particles.logo-image-hover.image.hover.lazy_load'
            ],
            'particles.logo-image-hover.effect' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.effect',
                'form_field' => false
            ],
            'particles.logo-image-hover.effect.overflow' => [
                'type' => 'input.checkbox',
                'label' => 'Overflow Hidden',
                'description' => 'Enable or disable the overflow hidden class. Useful for effects that would expand beyond the container.',
                'default' => 0,
                'name' => 'particles.logo-image-hover.effect.overflow'
            ],
            'particles.logo-image-hover.effect.single' => [
                'type' => 'select.select',
                'label' => 'Single Image',
                ...
                'name' => 'particles.logo-image-hover.effect.single'
            ],
            'particles.logo-image-hover.effect.multi' => [
                'type' => 'select.select',
                'label' => 'Multi Image',
                ...
                'name' => 'particles.logo-image-hover.effect.multi'
            ],
            'particles.logo-image-hover.js' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.js',
                'form_field' => false
            ],
            'particles.logo-image-hover.js.handle' => [
                'type' => 'select.select',
                'label' => 'JS Handling',
                ...
                'name' => 'particles.logo-image-hover.js.handle'
            ],
            'particles.logo-image-hover.cdn' => [
                'type' => '_parent',
                'name' => 'particles.logo-image-hover.cdn',
                'form_field' => false
            ],
            'particles.logo-image-hover.cdn.base_url' => [
                'type' => 'input.text',
                'label' => 'CDN Base URL',
                ...
                'name' => 'particles.logo-image-hover.cdn.base_url'
            ],
            'particles.logo-image-hover.js.placement' => [
                'type' => 'select.select',
                'label' => 'JS Placement',
                ...
                'name' => 'particles.logo-image-hover.js.placement'
            ],
            'particles.logo-image-hover.js.priority' => [
                'type' => 'input.text',
                'label' => 'JS Priority',
                'description' => 'The priority of the JS.',
                'default' => 0,
                'name' => 'particles.logo-image-hover.js.priority'
            ],
            'particles.logo-image-hover.js.option' => [
                'type' => 'select.select',
                ...
                'name' => 'particles.logo-image-hover.js.option'
            ],
            'particles.logo-image-hover.js.path' => [
                'type' => 'input.text',
                'label' => 'JS Path',
                ...
                'name' => 'particles.logo-image-hover.js.path'
            ],
            'particles.logo-image-hover.js.execution' => [
                'type' => 'select.select',
                'label' => 'JS Execution',
                ...
                'name' => 'particles.logo-image-hover.js.execution'
            ],
            'particles.scrollreveal-js' => [
                'type' => '_root',
                'form_field' => false,
        ...
        'nested' => [
            'particles' => [
                ...
                'logo-image-hover' => [
                    'enabled' => 'particles.logo-image-hover.enabled',
                    'tag' => [
                        'attributes' => 'particles.logo-image-hover.tag.attributes'
                    ],
                    'css' => [
                        'class' => 'particles.logo-image-hover.css.class'
                    ],
                    'render' => 'particles.logo-image-hover.render',
                    'link' => [
                        'enabled' => 'particles.logo-image-hover.link.enabled',
                        'url' => 'particles.logo-image-hover.link.url',
                        'target' => 'particles.logo-image-hover.link.target',
                        'title' => 'particles.logo-image-hover.link.title'
                    ],
                    'text' => [
                        'css' => [
                            'class' => 'particles.logo-image-hover.text.css.class'
                        ],
                        'text' => 'particles.logo-image-hover.text.text',
                        'position' => 'particles.logo-image-hover.text.position',
                        'style' => 'particles.logo-image-hover.text.style'
                    ],
                    'image' => [
                        'default' => [
                            'url' => 'particles.logo-image-hover.image.default.url',
                            'title' => 'particles.logo-image-hover.image.default.title',
                            'alt' => 'particles.logo-image-hover.image.default.alt',
                            'lazy_load' => 'particles.logo-image-hover.image.default.lazy_load'
                        ],
                        'hover' => [
                            'url' => 'particles.logo-image-hover.image.hover.url',
                            'title' => 'particles.logo-image-hover.image.hover.title',
                            'alt' => 'particles.logo-image-hover.image.hover.alt',
                            'lazy_load' => 'particles.logo-image-hover.image.hover.lazy_load'
                        ]
                    ],
                    'effect' => [
                        'overflow' => 'particles.logo-image-hover.effect.overflow',
                        'single' => 'particles.logo-image-hover.effect.single',
                        'multi' => 'particles.logo-image-hover.effect.multi'
                    ],
                    'js' => [
                        'handle' => 'particles.logo-image-hover.js.handle',
                        'placement' => 'particles.logo-image-hover.js.placement',
                        'priority' => 'particles.logo-image-hover.js.priority',
                        'option' => 'particles.logo-image-hover.js.option',
                        'path' => 'particles.logo-image-hover.js.path',
                        'execution' => 'particles.logo-image-hover.js.execution'
                    ],
                    'cdn' => [
                        'base_url' => 'particles.logo-image-hover.cdn.base_url'
                    ]
                ],
                'scrollreveal-js' => [
