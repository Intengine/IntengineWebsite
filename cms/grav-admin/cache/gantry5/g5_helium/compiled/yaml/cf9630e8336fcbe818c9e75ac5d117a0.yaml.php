...
return [
    ...
    'filename' => '/Users/sylwesterpilarz/Desktop/prgm/IntengineWebsite/cms/grav-admin/user/data/gantry5/themes/g5_helium/particles/jldivider.yaml',
    'modified' => 1569508330,
    'data' => [
        'name' => 'JL Divider',
        ...
        'form' => [
            ...
            'fields' => [
                ...
                'copyright' => [
                    'type' => 'separator.note',
                    'class' => 'alert alert-info',
                    'content' => 'JL Divider <strong>Version: 1.0.5</strong> Copyright (C) <a href="https://joomlead.com/" target="_blank">JoomLead</a>.'
                ]
            ]
        ]
    ]
