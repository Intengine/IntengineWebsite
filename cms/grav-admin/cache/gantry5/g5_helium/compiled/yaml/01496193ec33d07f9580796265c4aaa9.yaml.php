...
return [
    ...
    'filename' => '/Users/sylwesterpilarz/Desktop/IntengineWebsite/cms/grav-admin/user/themes/g5_helium/particles/jlopenstreetmap.yaml',
    'modified' => 1564677028,
    'data' => [
        ...
        'form' => [
            ...
            'fields' => [
                        ...
                        '_tab_content' => [
                            ...
                            'fields' => [
                                'items' => [
                                    ...
                                    'fields' => [
                                        '.latlong_info' => [
                                            ...
                                            'content' => 'Use the name of a place or address to find lat long coordinates <a href="https://www.latlong.net/" target="_blank">here</a>'
                                        ],
                                        '.latitude' => [
                                            'type' => 'input.text',
                                            'label' => 'Latitude',
                                ...
                                'token_info' => [
                                    'type' => 'separator.note',
                                    'class' => 'alert alert-info',
                                    'content' => 'Leave field default or request an access token <a href="https://www.mapbox.com/studio/account/tokens" target="_blank">here</a> in order to use tiles from Mapbox'
                                ],
                                'accesstoken' => [
                                    'type' => 'input.text',
                                    'label' => 'Access Token',
                ...
                'copyright' => [
                    'type' => 'separator.note',
                    'class' => 'alert alert-info',
                    'content' => 'JL Open Street Map <strong>Version: 1.0.4</strong> Copyright (C) <a href="https://joomlead.com/" target="_blank">JoomLead</a>.'
                ]
            ]
        ]
    ]
