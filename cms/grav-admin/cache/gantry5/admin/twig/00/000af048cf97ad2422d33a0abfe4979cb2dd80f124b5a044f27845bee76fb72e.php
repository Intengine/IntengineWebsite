...
class __TwigTemplate_8397a2432ffadf5bc9fdeac64bb869d694ed3c4fb817122c642224203f030f12 extends \Twig\Template
{
...
($context["gantry"] ?? null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/atoms.html.twig", "/Users/sylwesterpilarz/Desktop/IntengineWebsite/cms/grav-admin/user/plugins/gantry5/admin/templates/pages/configurations/page/atoms.html.twig");
    }
}
